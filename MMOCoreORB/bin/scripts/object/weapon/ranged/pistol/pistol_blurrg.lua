...
object_weapon_ranged_pistol_pistol_blurrg = object_weapon_ranged_pistol_shared_pistol_blurrg:new {
	...
	certificationsRequired = { "cert_pistol_blurrg" },
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_pistol_blurrg, "object/weapon/ranged/pistol/pistol_blurrg.iff")
