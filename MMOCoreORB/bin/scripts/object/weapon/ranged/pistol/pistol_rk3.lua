object_weapon_ranged_pistol_pistol_rk3 = object_weapon_ranged_pistol_shared_pistol_rk3:new {
	...
	certificationsRequired = { "cert_pistol_rk3" },
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_pistol_rk3, "object/weapon/ranged/pistol/pistol_rk3.iff")
