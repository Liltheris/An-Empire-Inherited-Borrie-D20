...
object_weapon_ranged_pistol_pistol_bryar = object_weapon_ranged_pistol_shared_pistol_bryar:new {
	...
	certificationsRequired = { "cert_pistol_bryar" },
...
ObjectTemplates:addTemplate(object_weapon_ranged_pistol_pistol_bryar, "object/weapon/ranged/pistol/pistol_bryar.iff")
