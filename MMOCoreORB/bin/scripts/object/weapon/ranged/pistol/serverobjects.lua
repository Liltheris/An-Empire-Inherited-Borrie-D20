...
includeFile("weapon/ranged/pistol/pistol_rk3.lua")
includeFile("weapon/ranged/pistol/pistol_dc17.lua")
includeFile("weapon/ranged/pistol/pistol_s5_combined.lua")