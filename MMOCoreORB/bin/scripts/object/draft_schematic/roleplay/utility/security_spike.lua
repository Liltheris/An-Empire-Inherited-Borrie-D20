arbineobject_draft_schematic_roleplay_utility_security_spike = object_draft_schematic_roleplay_utility_shared_security_spike:new {
...
}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_utility_security_spike, "object/draft_schematic/roleplay/utility/security_spike.iff")
