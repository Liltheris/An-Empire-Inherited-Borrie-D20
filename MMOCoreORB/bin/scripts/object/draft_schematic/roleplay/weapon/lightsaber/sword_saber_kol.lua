object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_kol = object_draft_schematic_roleplay_weapon_lightsaber_shared_sword_saber_kol:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/single/1h/sword_saber_kol.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_kol, "object/draft_schematic/roleplay/weapon/lightsaber/sword_saber_kol.iff")
