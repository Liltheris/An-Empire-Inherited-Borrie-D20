object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_ahsoka3 = object_draft_schematic_roleplay_weapon_lightsaber_shared_sword_saber_ahsoka3:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/single/2h/2h_saber_katana.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_2h_saber_katana, "object/draft_schematic/roleplay/weapon/lightsaber/2h_saber_katana.iff")
