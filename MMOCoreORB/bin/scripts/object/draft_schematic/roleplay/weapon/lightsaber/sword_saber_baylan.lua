object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_baylan = object_draft_schematic_roleplay_weapon_lightsaber_shared_sword_saber_baylan:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/single/1h/sword_saber_baylan.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_baylan, "object/draft_schematic/roleplay/weapon/lightsaber/sword_saber_baylan.iff")
