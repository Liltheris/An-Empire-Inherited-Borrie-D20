object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_sabine = object_draft_schematic_roleplay_weapon_lightsaber_shared_sword_saber_sabine:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/single/1h/sword_saber_sabine.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_sabine, "object/draft_schematic/roleplay/weapon/lightsaber/sword_saber_sabine.iff")
