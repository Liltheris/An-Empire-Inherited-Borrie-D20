...
}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_rifle_rifle_alliance_gauss, "object/draft_schematic/roleplay/weapon/rifle_alliance_gauss.iff")
