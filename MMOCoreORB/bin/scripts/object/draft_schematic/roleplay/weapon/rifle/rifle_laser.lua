object_draft_schematic_roleplay_weapon_rifle_rifle_laser = object_draft_schematic_roleplay_weapon_rifle_shared_rifle_laser:new {
...
}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_rifle_rifle_laser, "object/draft_schematic/roleplay/weapon/rifle/rifle_laser.iff")
