object_draft_schematic_roleplay_component_op_system_cold = object_draft_schematic_roleplay_component_shared_op_system_cold:new {
...
}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_component_op_system_cold, "object/draft_schematic/roleplay/component/op_system_cold.iff")
