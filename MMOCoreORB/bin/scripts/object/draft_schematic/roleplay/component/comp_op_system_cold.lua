object_draft_schematic_roleplay_component_comp_op_system_cold = object_draft_schematic_roleplay_component_shared_comp_op_system_cold:new {
	...
	resourceTypes = {"object/tangible/borrp/crafting/shared_circuit_board.iff","object/tangible/borrp/crafting/shared_comp_weapon_parts_rare.iff"},
	resourceQuantities = {1,1},
	contribution = {100,100},
	targetTemplate = "object/tangible/borrp/crafting/comp_op_system_cold.iff",
