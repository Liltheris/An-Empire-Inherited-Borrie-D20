object_draft_schematic_roleplay_component_component_saber_lense = object_draft_schematic_roleplay_component_shared_component_saber_lense:new {
	...
	ingredientTitleNames = {"circuit_board","scrap_metal","scrap_metal","comp_weapon_parts_rare"},
	...
	targetTemplate = "object/tangible/item/roleplay/shared_component_saber_lense.iff",
