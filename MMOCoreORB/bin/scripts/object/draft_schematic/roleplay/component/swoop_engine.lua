object_draft_schematic_roleplay_component_swoop_engine = object_draft_schematic_roleplay_component_shared_swoop_engine:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "swoop engine",
	...
	targetTemplate = "object/tangible/borrp/crafting/swoop_engine.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_component_swoop_engine, "object/draft_schematic/roleplay/component/swoop_engine.iff")
