object_draft_schematic_roleplay_component_op_system_electricty = object_draft_schematic_roleplay_component_shared_op_system_electricty:new {
...
}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_component_op_system_electricty, "object/draft_schematic/roleplay/component/op_system_electricty.iff")
