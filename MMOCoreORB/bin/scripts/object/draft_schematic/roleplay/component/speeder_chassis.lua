object_draft_schematic_roleplay_component_speeder_chassis = object_draft_schematic_roleplay_component_shared_speeder_chassis:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Speeder Chassis",
...
}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_component_speeder_chassis, "object/draft_schematic/roleplay/component/speeder_chassis.iff")
