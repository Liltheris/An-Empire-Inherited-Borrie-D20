arbineobject_draft_schematic_roleplay_item_computer_spike = object_draft_schematic_roleplay_item_shared_computer_spike:new {
...
}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_item_computer_spike, "object/draft_schematic/roleplay/item/computer_spike.iff")
