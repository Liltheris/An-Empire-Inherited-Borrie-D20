BorForce_Meditate = BorForce_BasePower:new({
	...
	helpString = "Restore your Force Pool as a short rest. You must be out of combat, and not in imminent danger to do this.",
})
...
function BorForce_Meditate:performAbility(pPlayer, fpi)
	...
	PlayerObject(pGhost):setForcePower(forcePowerMax)
