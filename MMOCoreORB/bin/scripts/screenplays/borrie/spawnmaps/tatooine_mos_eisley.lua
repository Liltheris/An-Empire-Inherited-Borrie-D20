...
function RpTatooineMosEisleyScreenPlay:spawnCivilians() 
	local waypointList = {
		...
		-- MEPD Civillian
		{-7.81303, -0.156781, 5.8475, 183, 610008453,{"sitchair"}},
...
function RpTatooineMosEisleyScreenPlay:spawnMobiles()
	...
	-- MEPD
	--Sitting
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  6.22988, 0.172025, -1.93499, 174, 610008455	,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_sitting_chair")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  9.28508, 0.172025, -1.96492, 177, 610008455	,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_sitting_chair")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  9.27013, 0.172025, -4.95448, 175, 610008455	,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_sitting_chair")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  3.27155, 0.172025, -4.97202, 172, 610008455	,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_sitting_chair")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -8.77239, -0.156781, 0.152693, 0, 610008453	,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_sitting_chair")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -8.89544, -0.156781, 2.59386, 0, 610008453		,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_sitting_chair")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -8.94615, -0.156781, 4.88315, 0, 610008453		,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_sitting_chair")
	-- Standing
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -4.54365, 0.307649, 6.91727, 73, 610008453	,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("conversation")
	createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -3.81011, 0.304384, 7.65657, 193, 610008453	,"rp_tatooine")
	createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -3.38565, 0.304239, 6.83057, 280, 610008453	,"rp_tatooine")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -4.39888, 0.300589, -5.85485, 149, 610008453	,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("npc_accusing")
	createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -3.72524, 0.299032, -6.55629, 313, 610008453	,"rp_tatooine")
	createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  -9.69001, -0.156781, 0.158965, 0, 610008453	,"rp_tatooine")
	pNpc = createTemplatedRoleplayNPC("planet/tatooine/mepd/police_officer",  7.28963, 0.489744, 3.69274, 89, 610008452		,"rp_tatooine")
	CreatureObject(pNpc):setMoodString("conversation")
	-- Swat
	createTemplatedRoleplayNPC("planet/tatooine/mepd/police_swat",  -6.21598, -3.97235, -9.66146, 0, 610008454		,"rp_tatooine")
	createTemplatedRoleplayNPC("planet/tatooine/mepd/police_swat",  -6.32326, -3.97235, -7.80086, 177, 610008454		,"rp_tatooine")
	--Magistrate
	pNpc = spawnRoleplayMobile("rp_rori", "rp_base_npc", 1, -807.38, 87.8477, 1597.4, 0, 0,				"rp_human_male", "faction/imperial/officer/lieutenant", "common/soldier_officer", "planet/tatooine/mepd/magistrate") --Dockmaster
	SceneObject(pNpc):setCustomObjectName("Bo-Kem Danno (An Imperial Magistrate)")
