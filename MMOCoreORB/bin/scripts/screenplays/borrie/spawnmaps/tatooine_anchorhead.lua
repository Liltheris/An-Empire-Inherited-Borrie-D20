...
function TatooineAnchorheadScreenPlay:spawnMobiles()
	...
	SceneObject(sObj):setCustomObjectName("a Target Dummy")
	spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, -719.624, 0, -1727.91, 180, 0, "tcg_target_dummy", "default", "default", "default") --Equip, Skill, Customization
	SceneObject(sObj):setCustomObjectName("a Target Dummy")
	spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, -717.095, 0, -1728.08, 164, 0, "tcg_target_dummy", "default", "default", "default") --Equip, Skill, Customization
	SceneObject(sObj):setCustomObjectName("a Target Dummy")
	spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, -714.273, 0, -1727.89, 180, 0, "tcg_target_dummy", "default", "default", "default") --Equip, Skill, Customization
	SceneObject(sObj):setCustomObjectName("a Target Dummy")
