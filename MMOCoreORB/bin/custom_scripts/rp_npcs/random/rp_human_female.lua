rp_human_female_random = {
	...
	hair = {
		...
		{0,1,2,4,5,6,7,8,9,10,11,12,14,15,16,18,20,21,22,23,24,26,27,31,32,34,37,38,39,40,41,42,78,79},
	},
...
rp_human_female_random_military = {
	paired_variables = {
	...
	random_variables = {
		...
		{"/shared_owner/blend_flat_chest", 100, 255},
