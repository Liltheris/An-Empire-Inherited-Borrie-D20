...
void BorUtil::SaveStructureContents(CreatureObject* creature, String name, String path = "custom_scripts/structure_prefabs/") {
...
void BorUtil::LoadStructureContents(CreatureObject* creature, String name) {
    ManagedReference<SceneObject*> rootParent = creature->getRootParent();
...
CreatureObject* BorUtil::CreateTemplatedRoleplayNPC(CreatureObject* creature, String rtemplate, String conversationTemplate = "") {
...
CreatureObject* BorUtil::CreateTemplatedRoleplayNPC(String rtemplate, float x, float z, float y, long parentID, String zoneID, String conversationTemplate = "") {
...
CreatureObject* BorUtil::CreateRoleplayNPC(String baseTemplate, String appearanceTemplate, float x, float z, float y, long parentID, String zoneid, String skillTemplate, String equipmentTemplate, String customizeTemplate, String conversationTemplate = "") {
...
void BorUtil::ApplySkillTemplateToNPC(CreatureObject* creature, CreatureObject* target, String skillTemplate) {
    Lua* lua = DirectorManager::instance()->getLuaInstance();
...
void BorUtil::ApplyEquipmentTemplateToNPC(CreatureObject* creature, CreatureObject* target, String equipmentTemplate) {
    try {
...
void BorUtil::SaveEquipmentToTemplate(CreatureObject* creature, const uint64& target, String name) {
...
void BorUtil::ApplyCustomizationTemplateToNPC(CreatureObject* creature, CreatureObject* target, String customizeTemplate) {
    Lua* lua = DirectorManager::instance()->getLuaInstance();
...
void BorUtil::ApplyRandomCustomizationToNPC(CreatureObject* creature, CreatureObject* target) {
    Lua* lua = DirectorManager::instance()->getLuaInstance();
...
void BorUtil::SaveCustomizationToTemplate(CreatureObject* creature, const uint64& target, String name) {
    ManagedReference<SceneObject*> object = creature->getZoneServer()->getObject(target, false);
...
void BorUtil::SaveRandomizationTemplate(CreatureObject* creature, const uint64& target, String name) {
    ManagedReference<SceneObject*> object = creature->getZoneServer()->getObject(target, false);
...
void BorUtil::PlaceStructureFromTemplate(CreatureObject* creature, String templateFile, String structureName = "") {
...
void BorUtil::CallScreenplayFunction(CreatureObject* creature, String screenPlay, String function) {
    Lua* lua = DirectorManager::instance()->getLuaInstance();
...
void BorUtil::TogglePublicContainer(CreatureObject* creature, const uint64& target) {
...
void BorUtil::ToggleDispenserContainer(CreatureObject* creature, const uint64& target) {
    ManagedReference<SceneObject*> object;
    if (target != 0) {
        object = creature->getZoneServer()->getObject(target, false);
    } else {
...
void BorUtil::SetDispenserContainer(SceneObject* object, bool isDispenser) {
    if(object != nullptr) {
        if(isDispenser) {
            object->setStoredInt("dispenser_container", 1);
        } else {
...
void BorUtil::SetPublicContainer(SceneObject* object, bool isPublic) {
    if(object != nullptr) {
        if(isPublic) {
            object->setStoredInt("public_container", 1);
        } else {
...
void BorUtil::ScreenplaySpoutCreature(CreatureObject* creature, SceneObject* target, String fileName) {
...
void BorUtil::ScreenplaySpoutRoleplayMobile(CreatureObject* creature, SceneObject* target, String fileName) {
    int angle = target->getDirectionAngle();
...
void BorUtil::ScreenplaySpoutCivPoint(CreatureObject* creature, SceneObject* target, String tag, String fileName) {
    int angle = target->getDirectionAngle();
...
void BorUtil::ScreenplaySpoutBasePoint(CreatureObject* creature, SceneObject* target, String tag, String fileName) {
    int angle = target->getDirectionAngle();
...
void BorUtil::ScreenplaySpoutCivPointWithMarker(CreatureObject* creature, String tag, String fileName) {
...
void BorUtil::ScreenplaySpoutCivPatrolPoint(CreatureObject* creature, bool delay, String animGroup, String fileName) {
    int angle = creature->getDirectionAngle();
...
void BorUtil::ScreenplaySpoutObject(CreatureObject* creature, SceneObject* object, String fileName) {
...
void BorUtil::NoLoadscreenTeleport(CreatureObject* creature, const UnicodeString& arguments) {
    float x, y;
    float z = 0;
...
void BorUtil::NoLoadscreenTeleportTo(CreatureObject* creature, const UnicodeString& arguments) {
    String targetName;
...
void BorUtil::PopulateObjectContents(CreatureObject* creature, SceneObject* target, String contentListTemplate) {
    try {
        Lua* lua = DirectorManager::instance()->getLuaInstance();
...
void BorUtil::CreateTravelBeacon(CreatureObject* creature, String code) {
...
void BorUtil::CreateContentListFromInventory(CreatureObject* creature, SceneObject* target, String contentListTemplate) {
    if(target == nullptr){
        return;
    }
...
TangibleObject* BorUtil::CreateLootbox(CreatureObject* creature, String objectTemplate, String contentList, bool noResell = true) {
    if(creature == nullptr){
        return nullptr;
    }
...
void BorUtil::SaveLocalArea(CreatureObject* creature, String fileName, int range) {
...
void BorUtil::LoadLocalArea(CreatureObject* creature, String fileName, bool snap) {
    Zone* zone = creature->getZone();
...
void BorUtil::ListAllStructures(CreatureObject* creature, String targetName) {
...
void BorUtil::ListAllStructures(CreatureObject* creature, CreatureObject* target) {
...
void BorUtil::DeleteStructureByID(CreatureObject* creature, uint64 oid) {
...
void BorUtil::SaveCharacterDataToFile(CreatureObject* creature, CreatureObject* targetMob) {
